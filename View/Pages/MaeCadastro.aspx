<%@ Page Language="C#" Inherits="View.Pages.MaeCadastro" %>
<!DOCTYPE html>
<html>
<head runat="server">
    <title>Mae</title>
  ...
  <div class="jumbotron">
   <form id="principal" runat="server" class="form-horizontal">
     <div class="form-group">
      ...
      <asp:Button id="btnCadastrar" runat="server" Text="Cadastrar" CssClass="btn btn-primary posicaoButton" OnClick="btnCadastrarMae" />      
       </div>
